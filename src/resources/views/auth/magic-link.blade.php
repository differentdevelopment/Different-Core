...
@section('content')
    <div class="row justify-content-center">
        <div class="col-12 col-md-8 col-lg-4">
            <h3 class="text-center mb-4">{{ __('different-core::magic-link.login') }}</h3>
            <div class="card">
                <div class="card-body">
                            ...
                            <div class="form-group">
                                <div>
                                    <button type="submit" class="btn btn-block btn-primary">
                                        {{ __('different-core::magic-link.post') }}
                                    </button>
                    ...
                    @else
                        <div class="alert alert-success" role="alert">
                            {{ __('different-core::magic-link.sent') }}
                        </div>
                    @endif
                </div>
            </div>
            <div class="text-center"><a href="{{ route('backpack.auth.login') }}">{{ __('different-core::magic-link.back_to_login') }}</a></div>
        </div>
    </div>
@endsection
