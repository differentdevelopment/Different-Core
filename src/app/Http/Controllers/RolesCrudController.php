...
class RolesCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        $this->crud->setRoute(backpack_url('roles'));
        $this->crud->setEntityNameStrings(__('different-core::roles.role'), __('different-core::roles.roles'));
        ...
        CrudTab::setTabs($this, [
            new NavbarItem(backpack_url('users'), "User", null, false, false),
            new NavbarItem(url('permissions'), "Permissions", null, false, false),
            new NavbarItem("#", "Roles", null, true, false),
        ], true);
    }
